...
.badge-high { background: rgba(239,68,68,.15); color: #dc2626; border: 1px solid rgba(239,68,68,.3); }
.badge-medium { background: rgba(245,158,11,.15); color: #d97706; border: 1px solid rgba(245,158,11,.3); }
.badge-low { background: rgba(139,92,246,.15); color: #7c3aed; border: 1px solid rgba(139,92,246,.3); }
.badge-info { background: rgba(107,114,128,.15); color: #6b7280; border: 1px solid rgba(107,114,128,.3); }
.badge-ok { background: rgba(16,185,129,.15); color: #059669; border: 1px solid rgba(16,185,129,.3); }
...
.cmp-table tr:nth-child(even) td { background: rgba(139,92,246,.05); }
